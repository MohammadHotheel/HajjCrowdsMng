<%@ Page Title='<%$ Resources:HCMResource, StateMang %>' Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StateList.aspx.cs" Inherits="HCM.WebApp.SSA.StateList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <form>
                <fieldset>
                    <legend><%= GetGlobalResourceObject("HCMResource","StateTitle") %></legend>
                    <div class="form-group row">
                        <div class="col-md-12">
                            <asp:LinkButton ID="lbAdd" runat="server" CssClass="btn btn-primary" Width="100px" PostBackUrl="~/Admin/StateMang.aspx">
        ...
        <div class="col-md-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:HCMResource, State %>'>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkUpdate" runat="server" CausesValidation="False" PostBackUrl='<%# String.Format("~/Admin/StateMang.aspx?Id={0}", Eval("Id")) %>'
