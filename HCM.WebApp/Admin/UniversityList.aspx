<%@ Page Title='<%$ Resources:HCMResource, UniversityMang %>' Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UniversityList.aspx.cs" Inherits="HCM.WebApp.SSA.UniversityList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <form>
                <fieldset>
                    <legend><%= GetGlobalResourceObject("HCMResource","UniversityTitle") %></legend>
                    <div class="form-group row">
                        <div class="col-md-12">
                            <asp:LinkButton ID="lbAdd" runat="server" CssClass="btn btn-primary" Width="100px" PostBackUrl="~/Admin/UniversityMang.aspx">
        ...
        <div class="col-md-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText='<%$ Resources:HCMResource, University %>'>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkUpdate" runat="server" CausesValidation="False" PostBackUrl='<%# String.Format("~/Admin/UniversityMang.aspx?Id={0}", Eval("Id")) %>'
